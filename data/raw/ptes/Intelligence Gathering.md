...
1.1.1 Level 1 Information Gathering

1.1.2 Level 2 Information Gathering

1.1.3 Level 3 Information Gathering
...
3.1 Identification and Naming of Target

3.2 Consider any Rules of Engagement limitations

3.3 Consider time length for test

3.4 Consider end goal of the test
...
4.1.1.1 Locations (L1)

4.1.1.2 Pervasiveness (L1)

4.1.1.3 Relationships (L1)
...
4.1.4.1 Document Metadata (L1/L2)

4.1.4.2 Marketing Communications (L1/L2)
...
6.2 Internal Footprinting

6.2.1 Passive Reconnaissance

6.2.2 Identify Customer Internal Ranges

6.2.3 Active Reconnaissance


7 Identify Protection Mechanisms

7.1 Network Based Protections

7.2 Host Based Protections

7.3 Application Level Protections

7.4 Storage Protections

7.5 User Protections
...
Retrieved from "http://www.pentest-standard.org/index.php?title=Intelligence_Gathering&oldid=953"
