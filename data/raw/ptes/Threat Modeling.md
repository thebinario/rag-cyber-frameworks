...
1.1 High level threat modeling process

1.2 Example

1.3 High level modeling tools
...
2.1.1 Policies, Plans, and Procedures

2.1.2 Product Information (e.g. trade secrets, R&D data)

2.1.3 Marketing Information (plans, roadmaps, etc.)

2.1.4 Financial Information (e.g. bank, credit, equity accounts)
...
3.1 Technical infrastructure supporting process

3.2 Information assets supporting process

3.3 Human assets supporting process

3.4 3rd party integration and/or usage of/by process


4 Threat Agents/Community Analysis

4.1 Employees

4.2 Management (Executive, middle)


5 Threat Capability Analysis

5.1 Analysis of tools in use

5.2 Availability to relevant exploits/payloads
...
6 Motivation Modeling

7 Finding relevant news of comparable Organizations being compromised
...
Retrieved from "http://www.pentest-standard.org/index.php?title=Threat_Modeling&oldid=956"
